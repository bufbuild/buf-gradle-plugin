...
open class BufExtension {
    ...
    /**
     * Specify an image file extension generated by `bufBuild`.
     */
    var bufBuildPublicationFileFormat: PublicationFileFormat = PublicationFileFormat.JSON

    /**
     * Specify an image file compression generated by `bufBuild`.
     */
    var bufBuildPublicationFileCompression: PublicationFileCompression? = null
...
enum class PublicationFileFormat(internal val format: String) {
    BINPB("binpb"),
    BIN("bin"),
    JSON("json"),
    TXTPB("txtpb"),
...
enum class PublicationFileCompression(internal val compression: String) {
    GZ("gz"),
    ZST("zst"),
}
