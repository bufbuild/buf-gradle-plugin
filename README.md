...
By default, the `bufGenerate` task will attempt to read a `buf.gen.yaml` template file from the root directory. You can override the location of the template file as such:
